...
public final class ServerLoader {
     ...
     * @throws IOException
     */
    private static <T extends ServerContextSupport> void loadServerConfig(Context context , Class<T> clazz) throws ServerConfigException {
...
//    }
     ...
     */
    public static <T extends ServerContextSupport> ServerConfig<T> getServerConfig(Context context , Class<T> sercerContextClass) throws ServerConfigException {
        if(config == null) {
            loadServerConfig(context , sercerContextClass);
        }
        return config;
    }
